...
typedef struct {
//   char * name; /*Internal name of the driver*/
//   char * path; /*Text name of the peripheral. For example /ONEWIRE/ or /GPIO/ or /somthing_else/ */
//   Peripheral_write_Function_t write; /*Function to read some bytes from peripheral*/
//   Peripheral_read_Function_t read;   /*Function to write some bytes to peripheral */
//   Peripheral_ioctl_Function_t ioctl; /*Function to ioctl peripheral*/
//   uint32_t countOfPerepherals;       /*Count of perepherals, that uses this driver*/
   driver_t * driver;
...
#define register_driver(d_name, d_path, d_write_f, d_read_f, d_ioctl_f, d_max_peripheral) \
