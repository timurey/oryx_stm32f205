...
#ifndef FS_DEPRECATED_API_SUPPORT
   #define FS_DEPRECATED_API_SUPPORT ENABLED
#elif (FS_DEPRECATED_API_SUPPORT != ENABLED && FS_DEPRECATED_API_SUPPORT != DISABLED)
   #error FS_DEPRECATED_API_SUPPORT parameter is not valid
#endif
...
//Deprecated API
#if (FS_DEPRECATED_API_SUPPORT == ENABLED)
   #define fsFileGetSize fsGetFileSize
   #define fsFileRename fsRenameFile
   #define fsFileDelete fsDeleteFile
   #define fsFileOpen fsOpenFile
   #define fsFileSeek fsSeekFile
   #define fsFileWrite fsWriteFile
   #define fsFileRead fsReadFile
   #define fsFileClose fsCloseFile
   #define fsDirCreate fsCreateDir
   #define fsDirRemove fsRemoveDir
   #define fsDirOpen fsOpenDir
   #define fsDirRead fsReadDir
   #define fsDirClose fsCloseDir
#endif
