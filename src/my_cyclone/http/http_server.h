...
#if (HTTP_SERVER_GZIPED_FILES == ENABLED)
   char_t gzipedDirectory[HTTP_SERVER_ROOT_DIR_MAX_LEN + 1];      ///<Web gziped root directory
#endif
...
struct _HttpConnection
{
   ...
   char_t buffer[HTTP_SERVER_BUFFER_SIZE] __attribute__ ((aligned (4)));             ///<Memory buffer for input/output operations
};

static const char * const wday_names[] = { "", "Mon", "Tue", "Wed", "Thu",  "Fri", "Sat", "Sun"};
