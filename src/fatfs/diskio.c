...
//	struct	tm	*time_fat;
//	extern int timezone;
//	tmp =getCurrentUnixTime() + 60UL*60*timezone;
//	time_fat=gmtime(&tmp);
//
//
//	res =  (((DWORD)time_fat->tm_year - 80) << 25)
//					| ((DWORD)(time_fat->tm_mon+1) << 21)
//					| ((DWORD)time_fat->tm_mday << 16)
//					| (WORD)(time_fat->tm_hour << 11)
//					| (WORD)(time_fat->tm_min << 5)
//					| (WORD)(time_fat->tm_sec >> 1);
//
//	return res;
	return fsGetFattime();
}
